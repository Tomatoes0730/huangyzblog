<template>
    <div class="navbar bg-base-100">
        <div class="navbar-start">
            ...
            <a class="btn btn-ghost normal-case text-xl">HUANGYZ</a>
        </div>
        <div class="navbar-center hidden lg:flex">
            <ul class="p-0 header-nav">
                <li class=""><a>首页</a></li>
                <li tabindex="0">
                    <a>
                        归档
...
.header-nav li > a {
    @apply m-0 pt-3 pb-3 pr-4 pl-3 text-[#1F294A] relative;
}
.header-nav > li > a:hover,
.header-nav > li > a:active {
    @apply bg-[#E8E9EB] rounded-lg;
}
/* hidden */
.sub-ul {
    @apply hidden absolute top-16;
}
.sub-ul li {
    @apply mb-3;
}
